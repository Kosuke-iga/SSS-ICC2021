...
In that case, only a client which forms MITM topology with a RAP can not receive ARP replys if its MAC address is duplicated and the other can get ARP replys since they can be sent to both of the duplicated addresses.

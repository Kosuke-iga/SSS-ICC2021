...
\begin{enumerate}
    ...
    \item To the best of our knowledge, the proposed scheme is the first one which independent of features of a RAP. By taking advantage of the feature of a LAP, the proposed scheme does not allow an adversary to avoid it by manipulating features of the RAP.
